...
function View({id}:{id:string}){const state=useArticleRewrite(id);return <><RewriteControls state={state} onToggle={()=>state.setVisible(!state.visible)} onOpenSettings={()=>{}}/><RewrittenArticle state={state}/></>;}
