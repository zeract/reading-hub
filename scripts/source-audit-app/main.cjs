...
const { redactDiagnosticMessage, redactDiagnosticUrl } = require("../../dist/main/main/diagnostic-redaction.js");
...
function safeError(error) {
  return error instanceof Error ? redactDiagnosticMessage(error.message) : "未知错误";
}
