...
/**
 * A request amortises App Server turn setup across a visible reading window.
 * This remains deliberately bounded: it is not an unrestricted article dump.
 */
export const MAX_AI_IMMERSIVE_TRANSLATION_SEGMENTS = 10;
export const MAX_AI_IMMERSIVE_TRANSLATION_SEGMENT_LENGTH = 1_600;
export const MAX_AI_IMMERSIVE_TRANSLATION_BATCH_LENGTH = 10_000;
