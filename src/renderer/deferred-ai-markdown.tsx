...
export const DeferredAiMarkdownContent = memo(function DeferredAiMarkdownContent({ text, entryId }: { text: string; entryId?: string }) {
  ...
  if (state.status === "ready") return <state.Renderer text={text} entryId={entryId} />;
