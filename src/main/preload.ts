...
const readerApi: ReaderApi = {
  ...
  readEntryLanguageVariant: (id, url, requestId, inlineLanguage) => ipcRenderer.invoke(IPC_CHANNELS.entry.readLanguageVariant, id, url, requestId, inlineLanguage),
  cancelEntryRead: (requestId) => ipcRenderer.invoke(IPC_CHANNELS.entry.cancelRead, requestId),
  openEmbeddedEntry: (id) => ipcRenderer.invoke(IPC_CHANNELS.entry.openEmbedded, id),
  loadArticleVideo: (id, url, requestId) => ipcRenderer.invoke(IPC_CHANNELS.entry.loadVideo, id, url, requestId),
  cancelArticleVideo: (requestId) => ipcRenderer.invoke(IPC_CHANNELS.entry.cancelVideo, requestId),
  loadArticleImage: (id, imageUrl, requestId) => ipcRenderer.invoke(IPC_CHANNELS.entry.loadImage, id, imageUrl, requestId),
  cancelArticleImage: (requestId) => ipcRenderer.invoke(IPC_CHANNELS.entry.cancelImage, requestId),
